package net.mcreator.tamesproredux;
...
@Mod("tames_proredux")
public class TamesProreduxMod {
	public static final Logger LOGGER = LogManager.getLogger(TamesProreduxMod.class);
	...
	public TamesProreduxMod(IEventBus modEventBus) {
		...
		TamesProreduxModTabs.REGISTRY.register(modEventBus);
		TamesProreduxModVariables.ATTACHMENT_TYPES.register(modEventBus);

		TamesProreduxModMenus.REGISTRY.register(modEventBus);
